#***FFT (fast fourier transform - for freq analysis of TS data)
# https://docs.scipy.org/doc/numpy/reference/routines.fft.html
# https://towardsdatascience.com/fast-fourier-transform-937926e591cb


def fastFourier(self, arr, bins):
    """
    Takes in array (arr) rotates # bins to the left
    as a Fourier transform. Returns vector (length equal to array input)
    arr = array
    bins = 
    """
    arr = asarray(arr)
